...
fn initOptions(allocator: std.mem.Allocator, options: *std.StringArrayHashMapUnmanaged(Option)) !void {
    ...
    try options.put(allocator, "Search", Option.initCombo("abNegamax var abNegamax var Minimax var Random", "abNegamax"));
    try options.put(allocator, "Evaluation", Option.initCombo("PSQTunedBB var PSQTunedBB var PSQTuned var PSQ var Shannon var ShannonHeuristics", "PSQTunedBB"));
}
